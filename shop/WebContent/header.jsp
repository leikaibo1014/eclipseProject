	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid" style="background-color: 	white">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: black">首页</a>
			</div>
				...
				$.post(
					...
					function(data){
						...
						for(var i=0;i<data.length;i++){
							...
							content+="<li><a href='${pageContext.request.contextPath}/product?method=productListByCid&cid="+data[i].cid+"' style= 'color: black'>"+data[i].cname+"</a></li>";
						}
