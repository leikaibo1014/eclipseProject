...
public class ProductServlet extends BaseServlet {
	...
	//servlet不用再做判断，统一提取到 BaseServlet中
	/*protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//获得请求的哪个方法的method
				...
				}else if("productInfoIndex".equals(methodName)){
					productInfoIndex(request,response);
				}
	...
	//模块中的功能是通过方法进行区分的,下面是对servlet的抽取
	...
	//显示首页的商品详细信息功能
	public void productInfoIndex(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//获得要查询的商品的pid
		String pid = request.getParameter("pid");
	...
	public void delProFromCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//以下方法为原正确代码，但是现在暂时没有支付功能，所以关闭注释掉
		//确认订单---更新收获人信息+在线支付
